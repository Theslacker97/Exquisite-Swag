...
!function(t) {
    ...
    n.extend(e.Mixer.prototype, {
        ...
        sortOperation: function(t) {
            ...
            t.newSort.collection ? t.newOrder = t.newSort.collection : "random" === t.newSort.order ? t.newOrder = n.arrayShuffle(t.startOrder) : "" === t.newSort.attribute ? (t.newOrder = e.origOrder.slice(),
